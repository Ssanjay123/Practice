...
// console.log(syr.charAt(0).toUpperCase()+syr.slice(1));
...
function removeWord(str,word){
    ...
    //     let number = newStr.indexOf(word)
    //     newStr.splice(number,1)
    //     return newStr.join(' ');
    //}
//     let newStr = str.split(' ');
//     let str2 = newStr.reduce((acc,item,index)=>{
//         if(item!=word){
//           acc.push(item)
//         }
//         return acc;
...
// console.log(removeWord("Hello My Sanjay Name is Sanjay Balaji.","Sanjay"))